  ...
  return (
    <div className="ABOUTmainContainer">
      <div className="allRightContent">
        ...
        <div className="allRightContentHeading">Strategies and Objectives</div>
        <div className="allRightContentProfile">
        <center></center>
        <hr />
        ...
        <Typography className="t">
          ...
          ❖ Facilitating the creation of a learner-centric environment conducive for quality education and faculty maturation to adopt the required<br /> knowledge and technology for participatory teaching and learning process.<br />
