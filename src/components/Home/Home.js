...
function Home() {
  ...
  <Link to="/about-policies" className="nav-link"><span role="img" aria-label="pointing-finger" className="blinking-text">👉🏻</span>The JNTU-GV Research Policy & Guidelines</Link>
        </ul>
      </div>
      <div className="column">
        <ul>
