            ...
            <div className="columns-container">
              <div className="column">
                <ul>
                  ...
                  <Link to="/about-acts-statuses" className="nav-link"><span role="img" aria-label="pointing-finger" className="blinking-text">👉🏻</span>The JNTU-GV University Act & Statutes</Link><br /><br />
